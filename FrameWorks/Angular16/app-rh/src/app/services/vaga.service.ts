...
import { HttpClient } from "@angular/common/http"; //solitações http (GET/POST/PUT/DELETE)
...
export class VagaService {
  ...
  private apiUrl = "http://localhost:3012/vagas"; //caminho para API

  constructor(private http: HttpClient) { } // ao instanciar o boj da classe, cria-se a conexão com o httpClient
